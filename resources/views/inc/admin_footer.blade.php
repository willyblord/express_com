        ...
        <div class="row no-gutters">
            <div class="col-lg-4 col-md-6">
                <div class="footer-top-box text-center">
                    ...
                    <h4 class="heading-5 mt-4">{{__('Go Digital')}}</h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-top-box text-center">
                    ...
                    <h4 class="heading-5 mt-4">{{__('Delivery')}}</h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-top-box text-center">
                    ...
                    <p>{{__('Thank you for choosing BM Express, we are grateful for your continued loyalty and your invaluable feedback, helps us to improve our services to fulfil your expectation. Please contact our customer care service <a hre="tel:2507820919168">+2507820919168</a> or <a href="mailto:customer@bmaexpress.com">customer@bmaexpress.com</a>. We are delighted to hear from you.')}}</p>
                </div>
            </div>
        </div>
    </div>

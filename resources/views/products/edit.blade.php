				    ...
				    <div class="tab-content">
						...
						<div id="demo-stk-lft-tab-9" class="tab-pane fade">
							...
							<div class="row bord-btm">
								<div class="col-md-2">
									<div class="panel-heading">
										<h3 class="panel-title">{{__('Delivery Note')}}</h3>
									</div>
								</div>
								<div class="col-md-10">
									<div class="form-group">
										...
										<div class="col-lg-7">
											<input type="text" class="form-control" name="delivery_note" placeholder="{{__('Delivery Note')}}" value="{{$product->delivery_note}}">
										</div>
									</div>
								</div>
							</div>

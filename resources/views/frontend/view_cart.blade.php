                                        ...
                                        <tbody>
                                            ...
                                            @foreach (Session::get('cart') as $key => $cartItem)
                                                ...
                                                if ($cartItem['variant'] != null) {
                                                  ...
                                                  $requetest =  $requetest." ".$product_name_with_choice."(QTY: ".$cartItem['quantity'].")"." Price: ".$cartItem['price'].", ";  
                ...
                <div class="col-xl-4 ml-lg-auto">
                    @include('frontend.partials.cart_summary')
                     ...
                     <div class="row align-items-center pt-4">
                            ...
                            <a href=" https://wa.me/+250789438395?text=Hello, am looking for this products: <?php echo $requetest?>" style="background-color:#075e54" type="button" class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart" onclick="whatsapME()">
                                            <i class="la la-whatsapp"></i>
                                            <span class=""> Order via whatsapp</span>
                                        </a>
...
@section('script')
    ...
    function updateCheck() {
        totalChecked = $('[name="cart[]"]:checked').length;
        totalStudents = '{{ Session::get('cart')->count() }}';

        if(totalChecked > 0) {
            document.getElementById('RemoveMultipleFromCart').disabled = false;
        } else {
            document.getElementById('RemoveMultipleFromCart').disabled = true;
        }

        document.getElementById('CountDelete').innerHTML = totalChecked;

        if (totalChecked == totalStudents) {
    ...
    $(document).ready(function() {
        $('#CheckAll').on('click', function() {
            if($('#CheckAll').is(':checked')) {
                ...
                document.getElementById('CountDelete').innerHTML = 0;
            }
        });
    });
    </script>

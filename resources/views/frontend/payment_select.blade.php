                                                    ...
                                                    @if($digital != 1)
                                                        <div class="col-6">
                                                            <label class="payment_option mb-4" data-toggle="tooltip" data-title="Cash on Delivery">
                                                                ...
                                                                <span>
                                                                    <img loading="lazy"  src="https://i.ibb.co/jJFqw4X/delivery.jpg" class="img-fluid">
                                                                </span>
                                                            </label>
                                                        </div>

                                                        <div class="col-6">
                                                            <label class="payment_option mb-4" data-toggle="tooltip" data-title="Pay With MOMO">
                                                                <input type="radio" id="" name="payment_option" value="momo_pay">
                                                                <span>
                                                                    <img loading="lazy"  src="https://i.ibb.co/tpnzDSH/mtn.jpg" class="img-fluid">
                                                                </span>
                                                            </label>
                                                        </div>

                                                        <div class="col-6">
                                                            <label class="payment_option mb-4" data-toggle="tooltip" data-title="Pay With Afripay">
                                                                <input type="radio" id="" name="payment_option" value="afripay">
                                                                <span>
                                                                    <img loading="lazy"  src="https://afripay.africa/logos/pay_with_afripay.png" class="img-fluid">
                                                                </span>
                                                            </label>
                                                        </div>
                                                    @endif

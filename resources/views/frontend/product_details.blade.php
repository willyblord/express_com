                        ...
                        <div class="product-description-wrapper">
                            ...
                            <div class="row align-items-center">
                                ...
                                @if (\App\BusinessSetting::where('type', 'conversation_system')->first()->value == 1)
                                    <div class="col-auto">
                                        <button class="btn" onclick="show_chat_modal()">{{__('Inquiry')}}</button>
                                    </div>
                                @endif
                            </div>
                            ...
                            <form id="option-choice-form">
                                ...
                                <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                                    <div class="col-12">
                                        <div class="product-description-label"><b>{{ $detailedProduct->delivery_note }}</b></div>
                                    </div>
                                </div>
                                ...
                                <div class="d-table-cell">
                                    ...
                                    @if ($qty > 0)
                                        ...
                                        <button type="button" class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart" onclick="addToCart()">
                                          ...
                                          <button style="background-color:#075e54" type="button" class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart" onclick="whatsapME()">
...
function whatsapME(){ 
    var current_product ="<?php echo $actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";?>";
    
    window.location="https://wa.me/+250789438395?text= I need more info on this product. "+current_product;

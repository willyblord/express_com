        ...
        <div class="row no-gutters">
            <div class="col-lg-4 col-md-6">
                <div class="footer-top-box text-center">
                    <img src="https://i.ibb.co/Bn9tcLJ/go-cachless.jpg" alt="go-cachless" class="img-fluid" width="200px">
                    
                    <h4 class="heading-5 mt-4">{{__('Delivery Options')}}</h4>
                    <p>{{__('We are delighted to welcome you to our online shopping platform. We sell and deliver different products including Groceries, Dietaries, Cooking Ingredients, Drinks and Baby food supplement and additives among others. We deliver for Personal, retail and wholesale in Kigali and other different parts of the country.')}}</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="footer-top-box text-center">
                    <img src="https://i.ibb.co/f4Pwj5C/pay-with.jpg" alt="pay-with" class="img-fluid" width="150px">
                    
                    <h4 class="heading-5 mt-4">{{__('Go Cashless')}}</h4>
                    <p>{{__('With BM Express you don’t need hard cash; continue enjoying your comfort while paying for your deliveries using the latest innovation in payment. Pay with MoMo, Airtel Money, Visa and master card, Bank Transfer. It is safe and secure.')}}</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="footer-top-box text-center">
                    <img src="https://i.ibb.co/PYRKn9V/reach-out.jpg" alt="reach-out" class="img-fluid" width="150px">
                    
                    <h4 class="heading-5 mt-4">{{__('Inquiries')}}</h4>
                    <p>{{__('Thank you for choosing BM Express, we are grateful for your continued loyalty and your invaluable feedback, helps us to improve our services to fulfil your expectation. Please contact our customer care service +2507820919168. or customer@bmaexpress.com. We are delighted to hear from you.')}}</p>
                </div>
            </div>
        </div>
    </div>

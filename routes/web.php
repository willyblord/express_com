...
Route::post('/cart/removeMultipleFromCart', 'CartController@removeMultipleFromCart')->name('cart.removeMultipleFromCart');
Route::post('/cart/updateQuantity', 'CartController@updateQuantity')->name('cart.updateQuantity');

//Checkout Routes
Route::group(['middleware' => ['checkout']], function () {
	Route::get('/checkout', 'CheckoutController@get_shipping_info')->name('checkout.shipping_info');
	Route::get('/checkout/shipping_fee', 'CheckoutController@shipping_fee')->name('checkout.shipping_fee');

...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $order->shipping_cost = $request->session()->get('shipping_info')['shipping_fee'];
        $order->shipping_desc = $request->session()->get('shipping_info')['shipping_desc'];
        ...
        if($order->save()){
            ...
            $order->grand_total = $subtotal + $tax + $request->session()->get('shipping_info')['shipping_fee'];
